...
axis equal
%Find the associated faces?
gt=V1surf;
figure;
trigt=delaunay(gt(:,1),gt(:,2));
trisurf(trigt,gt(:,1),gt(:,2),gt(:,3))
axis equal
%%
[trianglePoints,ia,ic]=unique(V1surf,'rows');
...
axis equal
save Data2balls.mat cgrid def_xs force_xs gt normal_gt normal_xs xs F1 F2 V1 V2 N1 Xcad2gt 
% save siliconFeb3balls.mat cgrid def_xs force_xs gt normal_gt normal_xs xs
%% ********** for 3balls data
clc;close all;clear
